...
| [`Fayette-Township-Meeting-Minutes-Archive.md`](Fayette-Township-Meeting-Minutes-Archive.md) | Full text of all 25 available Board of Supervisors meeting minutes, June 2024 – June 2026. A few were converted from user-uploaded `.odt` files via pandoc where the web version wasn't scrapable. |
